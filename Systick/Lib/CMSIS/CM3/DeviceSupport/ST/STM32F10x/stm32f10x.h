...
/** 
  ...
  * All RCC registers can be found in page 98/1133
  */
...
#define GPIOA_BASE            (APB2PERIPH_BASE + 0x0800)	/*!< Port A's address */
#define GPIOB_BASE            (APB2PERIPH_BASE + 0x0C00)	/*!< Port B's address */
#define GPIOC_BASE            (APB2PERIPH_BASE + 0x1000)	/*!< Port C's address */
#define GPIOD_BASE            (APB2PERIPH_BASE + 0x1400)	/*!< Port D's address */
